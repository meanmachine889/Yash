        ...
        <div className="flex flex-col-reverse lg:flex-row lg:justify-between lg:items-start gap-6 lg:gap-8">
          <div className="flex-1 space-y-4 sm:space-y-6">
            ...
            <div className="space-y-2 sm:space-y-3">
              <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-normal text-white leading-tight">
                I&apos;m Yash Bharadwaj
              </h1>
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 sm:gap-4">
                <Link href="https://github.com" aria-label="GitHub" className="hover:opacity-80 transition-opacity p-1">
                  <Image
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                ...
                <button className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-zinc-800 rounded-md text-gray-300 hover:bg-zinc-700 transition-colors text-sm sm:text-base font-medium">
